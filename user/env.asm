...
void env(int size, int interval, char* env_name) {
  ...
  2c:	05f5e9b7          	lui	s3,0x5f5e
  30:	1009899b          	addiw	s3,s3,256
        	if (pid == 0) {
  ...
  38:	8acb8b93          	addi	s7,s7,-1876 # 8e0 <malloc+0x100>
        		printf("%s %d/%d completed.\n", env_name, i, loop_size);
  3c:	3b9ad937          	lui	s2,0x3b9ad
  40:	a0090913          	addi	s2,s2,-1536 # 3b9aca00 <__global_pointer$+0x3b9ab8d7>
...
void env_large() {
  ...
  c6:	380080e7          	jalr	896(ra) # 442 <print_stats>
}
  ca:	60a2                	ld	ra,8(sp)
  cc:	6402                	ld	s0,0(sp)
...
void env_freq() {
  ...
  da:	00001617          	auipc	a2,0x1
  de:	82660613          	addi	a2,a2,-2010 # 900 <malloc+0x120>
  e2:	06400593          	li	a1,100
  e6:	06400513          	li	a0,100
  ea:	00000097          	auipc	ra,0x0
  ee:	f16080e7          	jalr	-234(ra) # 0 <env>
    print_stats();
  f2:	00000097          	auipc	ra,0x0
  f6:	350080e7          	jalr	848(ra) # 442 <print_stats>
}
  fa:	60a2                	ld	ra,8(sp)
  fc:	6402                	ld	s0,0(sp)
...
gets(char *buf, int max)
{
 ...
 230:	00098023          	sb	zero,0(s3) # 5f5e000 <__global_pointer$+0x5f5ced7>
  return buf;
}
 234:	855e                	mv	a0,s7
