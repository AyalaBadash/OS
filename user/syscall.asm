...
void pause_system_dem(int interval, int pause_seconds, int loop_size) {
  ...
  3c:	8d8b8b93          	addi	s7,s7,-1832 # 910 <malloc+0xe4>
  ...
  68:	70a080e7          	jalr	1802(ra) # 76e <printf>
  ...
  7e:	8b650513          	addi	a0,a0,-1866 # 930 <malloc+0x104>
  82:	00000097          	auipc	ra,0x0
  86:	6ec080e7          	jalr	1772(ra) # 76e <printf>
}
  8a:	60a6                	ld	ra,72(sp)
  8c:	6406                	ld	s0,64(sp)
  8e:	74e2                	ld	s1,56(sp)
...
void kill_system_dem(int interval, int loop_size) {
  ...
  d8:	864b0b13          	addi	s6,s6,-1948 # 938 <malloc+0x10c>
 ...
 104:	66e080e7          	jalr	1646(ra) # 76e <printf>
 ...
 118:	81c50513          	addi	a0,a0,-2020 # 930 <malloc+0x104>
 11c:	00000097          	auipc	ra,0x0
 120:	652080e7          	jalr	1618(ra) # 76e <printf>
}
